...
# Create Model
class Gate_Recurrent_Unit(nn.Module) : 
    def __init__ (self, input_size, hidden_size, num_layers, num_classes ): 
        super(Gate_Recurrent_Unit, self).__init__()
...
# Initialize Network
model = Gate_Recurrent_Unit(input_size, hidden_size, num_layers, num_classes).to(device=device) 
